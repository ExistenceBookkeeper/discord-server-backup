...
> Discord server backup tool, full export channels roles 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

💾 &nbsp;**Full backup** — channels, roles, settings, emojis

📎 &nbsp;**Member data** — optional member info export

☁️ &nbsp;**Local save** — backup stored as JSON file

🔄 &nbsp;**Scheduled** — automatic daily or weekly backups

♻️ &nbsp;**Restore** — recreate server structure from backup

📊 &nbsp;**Backup diff** — see what changed between backups
